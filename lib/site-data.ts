...
export const GITHUB_RELEASES = {
  api: "https://api.github.com/repos/GabrielSchmeisk/Orcamentos-Atualizacoes/releases/latest",
  fallback: "https://github.com/GabrielSchmeisk/Orcamentos-Atualizacoes/releases/latest",
} as const;
...
export const resourceGroups: ResourceGroup[] = [
  {
    ...
    items: ["Cadastro guiado de cliente e aparelho", "Serviços, peças, desconto, entrada e condição de pagamento", "Aprovação registrada com canal, responsável e versão aceita", "Filtros separados para ativos, finalizados e aparelhos abandonados", "Atendimentos com aparelhos vinculados e resumo conjunto", "Linha do tempo, mensagens e tentativas de contato registradas"],
  },
  {
    id: "clientes",
  ...
  },
  {
    ...
    icon: "bi-tools",
    items: ["Painel técnico para a mesma rede local privada", "Aviso ao técnico com o relato informado pelo cliente", "Tempo de manutenção a partir de 15 minutos", "Estoque real de peças com custo, movimento e reserva por orçamento", "Pesquisa de peças com urgência, fornecedor e lembretes", "Ficha técnica compacta de 17 × 15 cm em folha A4"],
  },
  {
    id: "garantias",
    ...
    items: ["Garantia criada a partir do atendimento finalizado", "Avaliação, decisão, serviços e peças obrigatórios na conclusão", "Pesquisa por cliente, aparelho, IMEI e número", "Exclusão controlada de garantia preenchida incorretamente", "Pasta única para retirada de produtos vinculados", "Fluxo documentado para aparelhos não retirados"],
  },
  {
    id: "aparelhos",
    kicker: "Comércio",
  ...
  },
  {
    ...
    items: ["Orçamento, ordem de serviço e comprovante de retirada", "Ficha técnica, garantia e etiquetas", "Ficha de transferência de dados", "Guia de contas após formatação", "Downloads automáticos na pasta escolhida", "Mensagens com histórico, falha, nova tentativa e confirmação manual"],
  },
  {
    id: "gestao",
    kicker: "Gestão",
    ...
    items: ["Faturamento, ticket médio e atendimentos finalizados", "Receitas, despesas e pagamentos parciais na central operacional", "Evolução de vendas com período selecionável", "Tempos de manutenção, funil e desempenho técnico", "Alertas de aprovações, pagamentos, duplicidades e peças urgentes", "Exportação contábil em CSV e PDF"],
  },
  {
    id: "seguranca",
    kicker: "Controle",
    ...
    icon: "bi-lock",
    items: ["Perfis e permissões por grupo de função", "Auditoria de alterações e ações sensíveis", "Banco SQLite local criptografado", "Backups autenticados, inclusive cópia externa configurável", "Diagnóstico da máquina sem expor dados comerciais", "Atualizações assinadas e licença com validação periódica"],
  },
];
...
export const faqs = [
  ...
  { q: "Precisa de internet para trabalhar?", a: "Os dados operacionais ficam no computador e o aplicativo tolera interrupções de conexão dentro da janela válida da licença. Ainda assim, é preciso conectar periodicamente para renovar a validação, receber revogações e usar ativação, sincronização e atualizações." },
  ...
  { q: "Como a licença é ativada?", a: "A forma principal é informar no aplicativo a chave de ativação recebida após a compra. Quando o atendimento assistido for necessário, o aplicativo também gera um arquivo .orcrequest e importa a licença .orclicense emitida para a mesma instalação." },
  { q: "Posso usar a mesma licença em mais de um computador?", a: "A licença é vinculada à instalação e à máquina autorizada. A contratação padrão não promete ativação simultânea em vários computadores; uma transferência ou nova ativação precisa ser combinada com o suporte." },
  ...
  { q: "A licença permanente vence?", a: "A modalidade permanente não possui data final de uso, mas continua vinculada à instalação, sujeita à validação periódica e às regras de revogação e transferência previstas nos termos." },
  ...
  { q: "Como baixo e atualizo o aplicativo?", a: "O botão Baixar app consulta a release estável mais recente no repositório oficial. Depois de instalado, o aplicativo verifica pacotes assinados, pode prepará-los em segundo plano e conclui a instalação no fechamento. O canal beta é opcional." },
...
export const guideArticles: GuideArticle[] = [
  { id: "instalacao", category: "Começar", title: "Instalação e primeiro acesso", summary: "Prepare o computador, instale, ative a licença e entre com uma conta.", body: ["Use um computador com Windows 10 ou 11 em 64 bits. Execute o instalador oficial e conclua os termos apresentados.", "Na primeira abertura, informe a chave de ativação recebida. Se o suporte orientar o fluxo assistido, gere o arquivo .orcrequest e importe o .orclicense correspondente. Depois, entre e configure a empresa."], steps: ["Baixar a versão estável oficial", "Concluir a instalação no Windows", "Informar a chave de ativação ou usar o fluxo assistido", "Entrar e configurar os dados da empresa"], tips: ["Se o Windows exibir uma confirmação de rede para o painel técnico, permita somente em redes privadas."] },
  ...
  { id: "garantias", category: "Pós-atendimento", title: "Abrir e concluir uma garantia", summary: "Vincule o retorno ao serviço original e registre a decisão técnica.", body: ["A garantia nasce de um orçamento finalizado. Localize por cliente, aparelho, IMEI, orçamento ou número da garantia.", "Registre avaliação, decisão, serviços e peças realizados. O andamento guarda responsáveis e mudanças. Uma conta autorizada pode excluir uma garantia criada incorretamente, removendo também a mensagem correspondente de Atendimentos e preservando a auditoria necessária."], steps: ["Abrir a partir do atendimento finalizado", "Avaliar prazo e problema", "Registrar decisão", "Informar serviços e peças e gerar o comprovante"], image: { src: assetPath("/assets/img/documentos/comprovante-retirada.png"), alt: "Comprovante de retirada gerado pelo aplicativo", caption: "Entrega, serviços, valores e responsáveis reunidos de forma clara." } },
