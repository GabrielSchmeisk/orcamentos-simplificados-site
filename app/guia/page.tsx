...
export const metadata: Metadata = { title: "Guia da versão 8.2 | Assistência Simplificada", description: "Manual pesquisável: instalação, ativação, Atendimentos, clientes, aparelhos, garantias, documentos, backup e segurança.", alternates: { canonical: "/guia" } };
