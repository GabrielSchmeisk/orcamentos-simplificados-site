export const PRODUCT = {
  ...
  purchaseLink: "/planos#como-adquirir",
...
export const documents = [
  { src: "/assets/img/documentos/orcamento.png", title: "Orçamento profissional", caption: "Cliente, aparelho, avaliação técnica, serviços e valores em um PDF padronizado." },
  { src: "/assets/img/documentos/ficha-tecnica.png", title: "Ficha para avaliação técnica", caption: "Documento interno compacto para acompanhar o aparelho na bancada." },
  { src: "/assets/img/documentos/pasta-garantia.png", title: "Pasta de produtos vinculados", caption: "Uma retirada conjunta, mantendo cada produto e garantia separados." },
  { src: "/assets/img/documentos/compra-usado.png", title: "Comprovante de compra de usado", caption: "Procedência, identificadores, testes, valor e assinaturas." },
];

export const visualGallery = [
  { src: "/assets/img/app/painel-principal.png", title: "Visão geral da operação", caption: "Resumo financeiro, alertas, exceções e acesso aos indicadores." },
  { src: "/assets/img/app/novo-orcamento.png", title: "Criando um orçamento", caption: "Cliente, aparelho, serviços, pagamento e revisão no mesmo fluxo." },
  ...documents,
];
