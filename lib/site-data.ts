...
export const documents = [
  ...
  { src: assetPath("/assets/img/documentos/ficha-tecnica.png"), title: "Ficha para avaliação técnica", caption: "Documento interno compacto para acompanhar o aparelho na bancada." },
  { src: assetPath("/assets/img/documentos/pasta-garantia.png"), title: "Pasta de produtos vinculados", caption: "Uma retirada conjunta, mantendo cada produto e garantia separados." },
...
export const visualGallery = [
  { src: assetPath("/assets/img/app/painel-principal.png"), title: "Visão geral da operação", caption: "Resumo financeiro, alertas, exceções e acesso aos indicadores." },
  { src: assetPath("/assets/img/app/novo-orcamento.png"), title: "Criando um orçamento", caption: "Cliente, aparelho, serviços, pagamento e revisão no mesmo fluxo." },
  ...documents,
];
